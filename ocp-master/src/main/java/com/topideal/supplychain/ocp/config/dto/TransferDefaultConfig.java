 ...
 * 接单及转单的默认配置订单数据
 */
public class TransferDefaultConfig implements Serializable {
    ...
    public TransferDefaultConfig(){ }

    private TransferDefaultConfig(Builder builder) {
    ...
    public static final class Builder {
        ...
        public TransferDefaultConfig build() {
            return new TransferDefaultConfig(this);
        }
