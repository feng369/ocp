...
public class OrderDistribution extends BaseEntity {
     ...
     * 推送系统
     */
    private ForwardSystemEnum pushSystem;
    ...
    //private BigBusiTypeEnum busiMode;
     ...
     * 是否商品备案
     */
    private YesOrNoEnum isGoodsRecord;
    ...
    public ForwardSystemEnum getPushSystem() {
        return pushSystem;
    }

    public void setPushSystem(ForwardSystemEnum pushSystem) {
    ...
    public YesOrNoEnum getIsGoodsRecord() {
        return isGoodsRecord;
    }

    public void setIsGoodsRecord(YesOrNoEnum isGoodsRecord) {
