...
/**
 * @ClassName EwFxRequest
 * @TODO TODO
 * @Author zhangzhihao
 * @DATE 2020/6/30 13:40
 * @Version 1.0
 **/
public class EwFxRequest implements Serializable {
    ...
    private EwFxRecipient recipient;
    private List<EwFxGoods> goodList;
    ...
    public EwFxRecipient getRecipient() {
        return recipient;
    }

    public List<EwFxGoods> getGoodList() {
        return goodList;
    }

    private EwFxRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder recipient(EwFxRecipient recipient) {
            this.recipient = recipient;
            return this;
        }

        public Builder goodList(List<EwFxGoods> goodList) {
            this.goodList = goodList;
            return this;
        }

        public EwFxRequest build() {
            return new EwFxRequest(this);
        }
    }
