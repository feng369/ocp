 ...
 * @version 1.0
 */
public class OfcBcExpGoodsReqDto implements Serializable {
    ...
    private OfcBcExpGoodsReqDto(Builder builder) {
        gnum = builder.gnum;
    ...
    public static final class Builder {
        ...
        public OfcBcExpGoodsReqDto build() {
            return new OfcBcExpGoodsReqDto(this);
        }
    }
