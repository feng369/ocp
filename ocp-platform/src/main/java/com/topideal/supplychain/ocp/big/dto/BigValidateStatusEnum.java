 ...
 * @version 1.0
 */
public enum BigValidateStatusEnum implements IntegerEnum {
    ...
    BigValidateStatusEnum(Integer value, String desc) {
        this.value = value;
        this.desc = desc;
    }
    ...
    public static BigValidateStatusEnum getValueEnum(Integer value) {
        for (BigValidateStatusEnum bigValidateStatusEnum : BigValidateStatusEnum.values()) {
