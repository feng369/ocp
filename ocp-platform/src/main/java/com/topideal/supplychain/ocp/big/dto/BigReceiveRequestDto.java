 ...
 * @version 1.0
 */
public class BigReceiveRequestDto implements Serializable {
    ...
    private BigRecipientRequestDto recipient;
    private List<BigGoodsRequestDto> goodList;
    ...
    public BigRecipientRequestDto getRecipient() {
        return recipient;
    }

    public void setRecipient(BigRecipientRequestDto recipient) {
        this.recipient = recipient;
    }

    public List<BigGoodsRequestDto> getGoodList() {
        return goodList;
    }

    public void setGoodList(List<BigGoodsRequestDto> goodList) {
