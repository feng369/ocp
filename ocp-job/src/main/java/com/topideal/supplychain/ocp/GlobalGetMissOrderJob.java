 ...
 */
@Component
public class GlobalGetMissOrderJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        //按照转单配置的数量进行抓单
        catchOrderConfigs.forEach(catchOrderConfig -> messageSender.send(QueueConstants.QueueEnum.OCP_GLOBAL_GET_MISS_ORDER, new BasicMessage(catchOrderConfig.getId(), catchOrderConfig.getCode())));
    }
}
